...
class BSNumKeyboardEx extends StatefulWidget {
  const BSNumKeyboardEx({super.key});

  @override
  State<BSNumKeyboardEx> createState() => _BSNumKeyboardExState();
}

class _BSNumKeyboardExState extends State<BSNumKeyboardEx> {
  String import = '0.00';
