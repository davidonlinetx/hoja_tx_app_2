...
//import 'package:hoja_tx_app_2/models/entries_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
import 'dart:convert';

import 'package:hoja_tx_app_2/models/combined_model.dart';
 import 'package:hoja_tx_app_2/models/expenses_model.dart';
import 'package:hoja_tx_app_2/models/features_model.dart';
 import 'package:hoja_tx_app_2/providers/db_expenses.dart';
 import 'package:hoja_tx_app_2/providers/db_features.dart';
...
class ExpensesProvider extends ChangeNotifier {
  ...
  */
  ...
  getExpensesByDate(int day, int month, int year) async {
    final response = await DBExpenses.db.getExpenseByDate(day, month, year);
    eList = [...response];
    notifyListeners();
  }
